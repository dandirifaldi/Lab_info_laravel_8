...
@section('title','Insert Buku')

@section('content')
	<div class="card card-primary">
              <!-- form start -->
   		<div class="card-body">
        	<form action="/barang/insertBuku" method="POST">
        		@csrf
            		<div>
                	...
                	<div class="col-sm-6">
                		...
                		<div class="form-group">
                        	...
                        	<select class=" form-control form-control-sm" name="tipe">
                          		...
                          		<option value="Buku Paket" {{(old('tipe')=='Buku Paket') ? 'selected' : ''}}>Buku Paket</option>
                          		<option value="Jurnal/Makalah" {{(old('tipe')=='Jurnal/Makalah') ? 'selected' : ''}}>Jurnal/Makalah</option>
                          		<!-- <option value="Tugas Akhir" {{(old('tipe')=='Tugas Akhir') ? 'selected' : ''}}>Tugas Akhir</option> -->
                        	</select>
                    	</div>
<!-- 		            	<div class="form-group">
               			 	<label>Harga </label>
