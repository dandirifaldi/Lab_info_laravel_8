        	...
        	<form action="/license/insert" method="POST">
            	...
            	<div class="row">
                	<div class="col-sm-6">
		                ...
		                <div class="form-group">
                    		<label for="lcs_name">License To Name<span style="color: red;">*</span></label>
                	...
                	<div class="col-sm-6">
                		<div class="form-group">
                        	...
                        	<select class="custom-select" name="category">
                          		...
                          		<option value="Office Software" {{(old('category')=='Office Software') ? 'selected' : ''}}>Office Software</option>
                          		<option value="Graphic Software" {{(old('category')=='Graphic Software') ? 'selected' : ''}}>Graphic Software</option>
                          		<option value="Programming Software" {{(old('category')=='Programming Software') ? 'selected' : ''}}>Programming Software</option>
                          		<option value="Software Tools" {{(old('category')=='Software Tools') ? 'selected' : ''}}>Software Tools</option>
