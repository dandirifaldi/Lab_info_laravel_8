        	...
        	<form action="/profile/update/{{$profile -> id}}" method="POST">
                ...
                <div class="input-group mb-5">
                  <label for="name" class="col-md-1 col-form-label">{{ __('Name :') }}</label>
                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $profile->name}}" autocomplete="name" autofocus placeholder="Input Name">
                  ...
                  <div class="input-group mb-5">
                    ...
                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $profile->email}}"  autocomplete="email" placeholder="Input Email">
                      <div class="input-group-text">
                        <span class="fas fa-envelope"></span>
                      </div>
                          <div class="invalid-feedback">
