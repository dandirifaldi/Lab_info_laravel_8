...
class BagusController extends Controller
{
    public function __construct()
    {
        ...
        $this -> BagusModel= new BagusModel();
    }

// BARANG HARDWARE-------------------------------------------------------------------------------------
    public function index(){
        $data=$this->BagusModel->allData();
        $dataBuku=$this->BagusModel->allDataBuku();
        $dataFurniture=$this->BagusModel->allDataFurniture();
        return view('v_barangBagus', ['barang'=>$data, 'buku'=>$dataBuku, 'furniture'=>$dataFurniture]);
    }
