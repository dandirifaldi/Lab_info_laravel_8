...
// BARANG HARDWARE-------------------------------------------------------------------------------------
    public function index(){
        $data=$this->MaintenanceModel->allData();
        $dataBuku=$this->MaintenanceModel->allDataBuku();
        $dataFurniture=$this->MaintenanceModel->allDataFurniture();
        return view('v_barangMaintenance', ['barang'=>$data, 'buku'=>$dataBuku, 'furniture'=>$dataFurniture]);
    }
